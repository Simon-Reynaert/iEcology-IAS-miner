# tests/test_wiki_geo_pageviews_2023_today.py
import unittest
import pandas as pd
...
from src.activity_mining.get_wiki_geo_pageviews_2023_till_today_final import fetch_and_process_pageviews
...
"""
    ...
    def test_fetch_and_process(self, mock_requests_get):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            expected_columns = ["Scientific Name", "Wikidata Q-number", "Country", "2025-01-01", "2025-01-02"]
